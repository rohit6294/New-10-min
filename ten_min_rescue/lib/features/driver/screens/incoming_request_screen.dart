...
class _IncomingRequestScreenState extends State<IncomingRequestScreen>
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton(
                            onPressed:
                                _accepting ? null : () => _accept(request),
  ...
  Widget _hospitalRow(String? hospitalId) {
    if (hospitalId == null || hospitalId.isEmpty) {
      return _infoRow(Icons.local_hospital_outlined, 'Hospital',
    ...
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder: (context, snap) {
        if (snap.connectionState != ConnectionState.done) {
          return _infoRow(
              Icons.local_hospital_outlined, 'Hospital', 'Loading...');
        }
        if (!snap.hasData || !snap.data!.exists) {
          return _infoRow(
              Icons.local_hospital_outlined, 'Hospital', 'Pre-selected');
        }
